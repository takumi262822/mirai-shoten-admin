...
旧版は「技術比較・参考実装」として残していますが、
セットアップ・運用・テスト・CI/CD・セキュリティ等は現行版のみを対象としています。
